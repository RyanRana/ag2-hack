...
PlantVillage classes). We map the 38 classes to Pesto's 7 CONDITION_LABELS
...
class DiseaseClassifierAgent(ChannelAgent):
    ...
    ``pesto.calibration.save_temperature("disease_classifier", T)``, the
    ...
    def _get_temperature(self) -> float:
        ...
        from pesto.calibration import load_temperature
